...
class FlatPage(models.Model):
    ...
    title = models.CharField(_('page title'), max_length=200, help_text=_('The title of the page is used in the HTML title of the page.'))
    name = models.CharField(_('link name'), max_length=80, default=_('unamed'), 
        help_text=_('The name of the page is used in creating links to pages and the breadcrumbs.'))
